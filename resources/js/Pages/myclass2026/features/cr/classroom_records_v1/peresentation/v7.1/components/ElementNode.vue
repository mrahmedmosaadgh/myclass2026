...
import GroupQuizV2 from './group-quiz-v2/GroupQuizV2.vue';
import LeaderboardV2 from './group-quiz-v2/leaderboard/LeaderboardV2.vue';
...
<template>
  ...
  >
    ...
    <!-- INTERACTIVE GROUP MCQ (V2 or V1) -->
    <GroupQuizV2
      v-else-if="element.type === 'group-mcq' && ui.useGroupQuizV2"
      :element="element"
      :isEditMode="ui.isEditMode"
      @update="(changes) => update(changes)"
      @select="if(ui.isEditMode) { ui.selectElement(element.id); showContextMenu = false; }"
    ...
    <!-- LEADERBOARD (V2 or V1) -->
    <LeaderboardV2
      v-else-if="element.type === 'leaderboard' && ui.useGroupQuizV2"
      :element="element"
      :isEditMode="ui.isEditMode"
      @update="(changes) => update(changes)"
      @select="if(ui.isEditMode) { ui.selectElement(element.id); showContextMenu = false; }"
