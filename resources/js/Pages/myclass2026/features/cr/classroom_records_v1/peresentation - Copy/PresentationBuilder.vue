    ...
    <div class="toolbar">
      ...
      <div class="toolbar-section">
        ...
        <button 
          ...
          :class="['btn', mode === 'animation' ? 'btn-active' : '']"
        >
          <span class="icon">✨</span> Animation Mode
        </button>
        <button 
          @click="mode = 'present'" 
...
import SlidePresenter from './SlidePresenter.vue';
...
export default {
  ...
  data() {
    return {
      ...
      currentSlideIndex: 0,
      mode: 'edit' // 'edit', 'animation', 'present'
    };
  },
  computed: {
    currentSlide() {
