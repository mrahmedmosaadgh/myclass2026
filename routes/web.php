...
// Local Development Routes - Exam Ready To Print (without domain restriction)
Route::prefix('exam/ready-to-print')->name('exam.ready-to-print.local.')->group(function () {
...
})->withoutMiddleware(['auth:sanctum', config('jetstream.auth_session'), 'verified'])->name('schedule.app.v2.offline-demo');
...
// Temporary public test route for V7 builder
...
Route::get('/builder-v7-test-drawing', function () {
    return Inertia::render(
        'myclass2026/features/cr/classroom_records_v1/peresentation/v7/DrawingTest',
        [
            'title' => 'Drawing Tools Test - V7'
        ]
    );
})->name('builder-v7.test.drawing');
